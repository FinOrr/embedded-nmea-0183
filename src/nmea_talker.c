...
static const nmea_talker_entry_t g_talker_table[] = {
    {"AG", NMEA_TALKER_AG}, {"AI", NMEA_TALKER_AI},
    {"AP", NMEA_TALKER_AP}, {"CD", NMEA_TALKER_CD},
    {"CR", NMEA_TALKER_CR}, {"CS", NMEA_TALKER_CS},
    {"CT", NMEA_TALKER_CT}, {"CV", NMEA_TALKER_CV},
    {"CX", NMEA_TALKER_CX}, {"DF", NMEA_TALKER_DF},
    {"DM", NMEA_TALKER_DM}, {"EC", NMEA_TALKER_EC},
    {"EP", NMEA_TALKER_EP}, {"ER", NMEA_TALKER_ER},
    {"GL", NMEA_TALKER_GL}, {"GN", NMEA_TALKER_GN},
    {"GP", NMEA_TALKER_GP}, {"HC", NMEA_TALKER_HC},
    {"HE", NMEA_TALKER_HE}, {"HN", NMEA_TALKER_HN},
    {"II", NMEA_TALKER_II}, {"IN", NMEA_TALKER_IN},
    {"LC", NMEA_TALKER_LC}, {"P", NMEA_TALKER_P}, /* Note: Single character */
    {"RA", NMEA_TALKER_RA}, {"SD", NMEA_TALKER_SD},
    {"SN", NMEA_TALKER_SN}, {"SS", NMEA_TALKER_SS},
    {"TI", NMEA_TALKER_TI}, {"VD", NMEA_TALKER_VD},
    {"VW", NMEA_TALKER_VW}, {"WI", NMEA_TALKER_WI},
    {"YX", NMEA_TALKER_YX}, {"ZA", NMEA_TALKER_ZA},
    {"ZC", NMEA_TALKER_ZC}, {"ZQ", NMEA_TALKER_ZQ},
    {"ZV", NMEA_TALKER_ZV},
};
