...
typedef struct {
    ...
    float magnetic_deviation;          /**< Magnetic deviation, degrees (E positive, W negative) */
    float magnetic_variation;          /**< Magnetic variation, degrees (E positive, W negative) */
...
nmea_result_t nmea_parse_hdg(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_HDT_ENABLED
nmea_result_t nmea_parse_hdt(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_ROT_ENABLED
nmea_result_t nmea_parse_rot(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_VTG_ENABLED
nmea_result_t nmea_parse_vtg(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif
...
nmea_result_t nmea_parse_osd(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_HMR_ENABLED
nmea_result_t nmea_parse_hmr(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_HTC_ENABLED
nmea_result_t nmea_parse_htc(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif
