...
nmea_result_t nmea_parse_dse(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_VER_ENABLED
nmea_result_t nmea_parse_ver(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_UID_ENABLED
nmea_result_t nmea_parse_uid(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_SPW_ENABLED
nmea_result_t nmea_parse_spw(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_TUT_ENABLED
nmea_result_t nmea_parse_tut(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_TXT_ENABLED
nmea_result_t nmea_parse_txt(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_NAK_ENABLED
nmea_result_t nmea_parse_nak(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_RLM_ENABLED
nmea_result_t nmea_parse_rlm(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_STN_ENABLED
nmea_result_t nmea_parse_stn(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif
