...
nmea_result_t nmea_parse_wpl(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_WNC_ENABLED
nmea_result_t nmea_parse_wnc(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif

#if NMEA_SENTENCE_WCV_ENABLED
nmea_result_t nmea_parse_wcv(struct nmea_context *ctx, const struct nmea_tokens *tokens);
#endif
