 ...
 *
 * @note This library is designed for embedded systems with zero heap allocation.
 */
 ...
 */
typedef void (*nmea_error_callback_t)(
 ...
 */
typedef struct {
    float degrees;      /**< Decimal degrees (-90 to 90 for lat, -180 to 180 for lon) */
 ...
 *
 * This structure contains tokenized sentence fields. Defined in nmea_internal.h.
 * Used internally by parsers.
 */
