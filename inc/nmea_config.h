 ...
 *  Sentences: VDM, VDO, ABK, ABM, ACA, ACS, AIR, BBM, LR1, LR2, LR3, LRF, LRI,
 * SSD, VSD */
 ...
 *  Sentences: XDR, XTE, XTR, ZDA, ZDL, ZFO, ZTG, DTM, CUR, FSI, GEN, RPM, SFI,
 * DDC, EPV, etc. */
...
/** @brief Maximum sentence length to accept (NMEA standard = 82, extended for
 * AIS = 128) */
